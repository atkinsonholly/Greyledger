...
holly = User.create!(email: "holly@gmail.com", password: "123456", first_name: "Holly", last_name: "Atkinson")
jack = User.create!(email: "jack@gmail.com", password: "123456", first_name: "Jack", last_name: "Ling")
